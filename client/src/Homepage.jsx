...
export default function Homepage() {
  ...
  //     img: "https://c4.wallpaperflare.com/wallpaper/592/1022/336/inception-cast-wallpaper-preview.jpg",
  //   },
  //   {
  //     movieId: 2,
  //     title: "The Matrix",
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent p-4 flex items-center justify-center">
                  <div className="text-center text-white p-12 bg-black bg-opacity-70 rounded-lg shadow-lg max-w-md">
                    ...
                    >
                      <button className="mt-6 bg-blue-600 hover:bg-blue-800 transition duration-300 ease-in-out text-white font-bold py-2 px-6 rounded-lg shadow-lg">
                        View Details
                      </button>
                    </Link>
                  </div>
